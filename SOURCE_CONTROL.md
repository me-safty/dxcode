...
- Generated from `upstream/main` `4ac094fef689b71f475e41a9a2fce167804a5e4e` with starting branch HEAD `a619fa3d61f175301db8fd899c5d7e4191f3cdbb`; the merge created local merge commit `7a2662620812d08203decc98ac446844dae56004`.
- Shared refs at merge time: `origin/main` `971d84d803e04f07314dddbe3b5a3660f5b6956e`, local `main` `971d84d803e04f07314dddbe3b5a3660f5b6956e`.
- Effective branch delta after the merge and this snapshot refresh: `71 ahead / 0 behind upstream/main`, `73 ahead / 433 behind origin/main`, `73 ahead / 433 behind local main`; current working-tree fork diff size is `56 files changed, 15209 insertions(+), 349 deletions(-)` against the `upstream/main` tree.
- Merge note: upstream commits `a7e43b2280e98ab146858a4d98920fd25df6e2ba` and `4ac094fef689b71f475e41a9a2fce167804a5e4e` brought the Vite Plus upgrade with bundled-dev opt-in plus mobile pending-task and draft-flow updates. Git merged these changes without conflict markers or manual conflict resolutions. The incoming work did not touch the Version Control source files or right-panel source-control glue directly, so the branch preserved its source-control/sidebar glue, right-panel surface gating, thread metadata routing, draft metadata updates, structured/stale errors, hook lifetime sequencing, status-derived default branch, stale branch path filtering, rename fallback suppression, VCS watcher retention, cwd-scoped enrichment, selected-file commit/merge hardening, stable stash keys, source-control cache refreshes, right-panel add-surface action refactor, remote-name-aware branch parsing, and the behavior notes in this file. No Version Control panel customization was retired, no upstream implementation made this branch's panel work obsolete, and no new source-control fork customization was introduced by the merge.

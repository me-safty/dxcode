...
- Generated from `upstream/main` `6009720844f053e048e18ca1abe4f429559ab9fc` with starting branch HEAD `ca848a863c5543b643e404c790687fb39ba00f9d`; the merge created local merge commit `0a85ac663a9f2acc0c6f59730b5c81c911581a3a`.
- Shared refs at merge time: `origin/main` `4d9679af7581dede0b9a84d702ce9a843ef7c955`, local `main` `4d9679af7581dede0b9a84d702ce9a843ef7c955`.
- Effective branch delta after the merge and this snapshot refresh: `73 ahead / 0 behind upstream/main`, `75 ahead / 435 behind origin/main`, `75 ahead / 435 behind local main`; current working-tree fork diff size is `56 files changed, 15209 insertions(+), 349 deletions(-)` against the `upstream/main` tree.
- Merge note: upstream commits `e26e55f38e07799b48d8672bf20a9cf4cbf27378` and `6009720844f053e048e18ca1abe4f429559ab9fc` brought the mobile combined test branch fixes for scroll, back-swipe, thread lists, computer switching, new-task flow handling, mobile time formatting, and the repo-root `favicon.svg`. Git merged these changes without conflict markers or manual conflict resolutions. The incoming work did not touch the Version Control source files or right-panel source-control glue directly, so the branch preserved its source-control/sidebar glue, right-panel surface gating, thread metadata routing, draft metadata updates, structured/stale errors, hook lifetime sequencing, status-derived default branch, stale branch path filtering, rename fallback suppression, VCS watcher retention, cwd-scoped enrichment, selected-file commit/merge hardening, stable stash keys, source-control cache refreshes, right-panel add-surface action refactor, remote-name-aware branch parsing, and the behavior notes in this file. No Version Control panel customization was retired, no upstream implementation made this branch's panel work obsolete, and no new source-control fork customization was introduced by the merge.

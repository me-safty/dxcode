...
- If an Electron API must run synchronously before `app.ready`, keep that call outside the Effect layer graph and document the ordering requirement at the call site.

  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Salchi prerelease is available for nightly testers."
          : "A new Salchi latest release is available.",
...
).pipe(Command.withDescription("Post a Salchi release announcement to Discord."));

...
more Code reads keybindings from:

- `~/.moreCode/keybindings.json`
...
- `chat.new`: create a new chat thread preserving the active thread's branch/worktree state for regular projects; sections receive a fresh server-managed worktree

...
import type { IsoDateTime, MessageId, ProjectId } from "@t3tools/contracts";
...
export interface TicketRow {
  ...
  // PR view — present when a p_workflow_boards_pr_state row exists for this ticket.
...
export interface WorkflowReadModelShape {
  ...
  // Full p_workflow_boards_pr_state row for a ticket, or null when no PR has been opened.
...
export class WorkflowReadModel extends Context.Service<WorkflowReadModel, WorkflowReadModelShape>()(
  "@t3tools/fixture-workflow-boards/server/workflow/Services/WorkflowReadModel",
) {}

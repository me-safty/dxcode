...
import type { BoardId, LaneKey } from "../../../contracts/workflow.ts";
...
// into `p_workflow_boards_work_source_mapping.source_metadata_json` and surfaced by Task 13.
...
export interface WorkflowSourceCommitterShape {
  ...
  // p_workflow_boards_work_source_mapping table under admission(OUTER) -> save(INNER) ->
...
>()("@t3tools/fixture-workflow-boards/server/workflow/Services/WorkflowSourceCommitter") {}

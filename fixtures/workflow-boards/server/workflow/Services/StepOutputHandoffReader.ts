import type { LaneKey, PipelineRunId, StepKey, TicketId } from "../../../contracts/workflow.ts";
 ...
 * `projection_step_run` to `projection_pipeline_run` so it can resolve the right
 * pass across loops.
 */
...
>()("@t3tools/fixture-workflow-boards/server/workflow/Services/StepOutputHandoffReader") {}

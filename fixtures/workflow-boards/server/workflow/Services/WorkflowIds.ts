...
export interface WorkflowIdsShape {
  ...
  // Opaque unique id for a p_workflow_boards_work_source_mapping row (Task 9 committer). Not a
...
export class WorkflowIds extends Context.Service<WorkflowIds, WorkflowIdsShape>()(
  "@t3tools/fixture-workflow-boards/server/workflow/Services/WorkflowIds",
) {}

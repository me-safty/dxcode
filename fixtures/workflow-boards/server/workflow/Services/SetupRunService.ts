import type { SetupRunId, TicketId } from "../../../contracts/workflow.ts";
...
export class SetupTerminalPort extends Context.Service<SetupTerminalPort, SetupTerminalPortShape>()(
  "@t3tools/fixture-workflow-boards/server/workflow/Services/SetupRunService/SetupTerminalPort",
) {}
...
export class SetupRunService extends Context.Service<SetupRunService, SetupRunServiceShape>()(
  "@t3tools/fixture-workflow-boards/server/workflow/Services/SetupRunService",
) {}

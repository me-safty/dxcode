// This file mostly exists because we want dev mode to say "Workbench (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Workbench (Dev)" : "Workbench (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "com.workbench.app.dev" : "com.workbench.app";

// This file mostly exists because we want dev mode to say "Neuropharm Research (Dev)" instead of "electron"
...
export const APP_DISPLAY_NAME = isDevelopment
  ? "Neuropharm Research (Dev)"
  : "Neuropharm Research (Alpha)";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.t3tools.neuropharmresearch.dev.${devBundleIdSuffix || "local"}`
  : "com.t3tools.neuropharmresearch";

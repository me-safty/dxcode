...
const defaultEnvironmentInput = {
  ...
  processArch: "arm64",
  appVersion: "1.2.3",
  appPath: "/Applications/Neuropharm Research.app/Contents/Resources/app.asar",
  isPackaged: true,
  resourcesPath: "/Applications/Neuropharm Research.app/Contents/Resources",
...
const makeElectronAppLayer = (calls: ElectronAppCalls) =>
  Layer.succeed(ElectronApp.ElectronApp, {
    ...
    name: Effect.succeed("Neuropharm Research"),
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["Neuropharm Research (Alpha)"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "Neuropharm Research (Alpha)");

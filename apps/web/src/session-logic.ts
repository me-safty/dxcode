...
import {
  derivePendingApprovals as derivePendingApprovalsFromActivities,
  derivePendingUserInputs as derivePendingUserInputsFromActivities,
...
export const derivePendingApprovals = derivePendingApprovalsFromActivities;
export const derivePendingUserInputs = derivePendingUserInputsFromActivities;

  ...
  const api: NativeApi = {
    ...
    server: {
      ...
      listProviderCommands: (input) =>
        transport.request(WS_METHODS.serverListProviderCommands, input),
      executeProviderCommand: (input) =>
        transport.request(WS_METHODS.serverExecuteProviderCommand, input),

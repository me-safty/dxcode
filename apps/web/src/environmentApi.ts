...
export function createEnvironmentApi(rpcClient: WsRpcClient): EnvironmentApi {
  return {
    ...
    vcs: {
      ...
      undoLatestCommit: rpcClient.vcs.undoLatestCommit,
      revertCommit: rpcClient.vcs.revertCommit,
      checkoutCommit: rpcClient.vcs.checkoutCommit,
      createBranchFromCommit: rpcClient.vcs.createBranchFromCommit,
      mergeBranchIntoCurrent: rpcClient.vcs.mergeBranchIntoCurrent,
      rebaseCurrentOnto: rpcClient.vcs.rebaseCurrentOnto,

...
function readRootThemeVar(styles: CSSStyleDeclaration, name: string, fallback: string): string {
...
function terminalThemeFromApp(): ITheme {
  ...
  const background = readRootThemeVar(
    rootStyles,
    "--background",
    bodyStyles.backgroundColor || "#1e1e2e",
  );
  const foreground = readRootThemeVar(rootStyles, "--foreground", bodyStyles.color || "#cdd6f4");
  return {
    background,
    foreground,
    cursor: readRootThemeVar(rootStyles, "--primary", isDark ? "#cba6f7" : "#8839ef"),
    selectionBackground: readRootThemeVar(
      rootStyles,
      "--terminal-selection",
      isDark ? "#89b4fa40" : "#1e66f533",
    ),
    scrollbarSliderBackground: isDark ? "rgba(166, 173, 200, 0.16)" : "rgba(108, 111, 133, 0.16)",
    scrollbarSliderHoverBackground: isDark
      ? "rgba(166, 173, 200, 0.24)"
      : "rgba(108, 111, 133, 0.24)",
    scrollbarSliderActiveBackground: isDark
      ? "rgba(166, 173, 200, 0.3)"
      : "rgba(108, 111, 133, 0.3)",
    black: readRootThemeVar(rootStyles, "--ctp-surface1", isDark ? "#45475a" : "#bcc0cc"),
    red: readRootThemeVar(rootStyles, "--ctp-red", isDark ? "#f38ba8" : "#d20f39"),
    green: readRootThemeVar(rootStyles, "--ctp-green", isDark ? "#a6e3a1" : "#40a02b"),
    yellow: readRootThemeVar(rootStyles, "--ctp-yellow", isDark ? "#f9e2af" : "#df8e1d"),
    blue: readRootThemeVar(rootStyles, "--ctp-blue", isDark ? "#89b4fa" : "#1e66f5"),
    magenta: readRootThemeVar(rootStyles, "--ctp-mauve", isDark ? "#cba6f7" : "#8839ef"),
    cyan: readRootThemeVar(rootStyles, "--ctp-sapphire", isDark ? "#74c7ec" : "#209fb5"),
    white: readRootThemeVar(rootStyles, "--ctp-subtext1", isDark ? "#bac2de" : "#5c5f77"),
    brightBlack: readRootThemeVar(rootStyles, "--ctp-surface2", isDark ? "#585b70" : "#acb0be"),
    brightRed: readRootThemeVar(rootStyles, "--ctp-maroon", isDark ? "#eba0ac" : "#e64553"),
    brightGreen: readRootThemeVar(rootStyles, "--ctp-teal", isDark ? "#94e2d5" : "#179299"),
    brightYellow: readRootThemeVar(rootStyles, "--ctp-peach", isDark ? "#fab387" : "#fe640b"),
    brightBlue: readRootThemeVar(rootStyles, "--ctp-lavender", isDark ? "#b4befe" : "#7287fd"),
    brightMagenta: readRootThemeVar(rootStyles, "--ctp-pink", isDark ? "#f5c2e7" : "#ea76cb"),
    brightCyan: readRootThemeVar(rootStyles, "--ctp-sky", isDark ? "#89dceb" : "#04a5e5"),
    brightWhite: readRootThemeVar(rootStyles, "--ctp-text", isDark ? "#cdd6f4" : "#4c4f69"),
  };
}

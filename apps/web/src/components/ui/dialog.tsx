...
function DialogCenteredViewport({ className, ...props }: DialogPrimitive.Viewport.Props) {
  return (
    <DialogPrimitive.Viewport
...
function DialogPopup({
  ...
  const Viewport = centered ? DialogCenteredViewport : DialogViewport;
  return (
    <DialogPortal>
      <DialogBackdrop />
      <Viewport

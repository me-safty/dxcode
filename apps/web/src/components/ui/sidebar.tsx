  ...
  return (
    <button
      ...
      className={cn(
        ...
        "-translate-x-1/2 group-data-[side=left]:-right-4 absolute inset-y-0 z-20 hidden w-4 transition-colors duration-150 after:pointer-events-none after:absolute after:inset-y-0 after:left-1/2 after:w-px after:-translate-x-1/2 after:bg-border/80 after:opacity-0 after:content-[''] after:transition-opacity after:duration-150 hover:after:opacity-100 active:after:opacity-100 dark:after:bg-[linear-gradient(to_bottom,transparent_0%,transparent_20%,rgb(255_255_255_/_0.2)_50%,transparent_80%,transparent_100%)] group-data-[side=right]:left-0 sm:flex [[data-collapsible=offcanvas][data-state=collapsed]_&]:pointer-events-none",

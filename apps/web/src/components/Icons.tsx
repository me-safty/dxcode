...
export const KittyIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 240 240" fill="none">
    <g transform="translate(0 -812.362)">
      <rect x="72.824" y="850.13" width="100.446" height="161.551" fill="#ddd" />
      <path
      ...
      />
      <g fill="#2b1100">
        <path d="M168.507 903.265c15.318-19.148 46.72-28.339 67.655-15.063-24.509-3.83-46.72 2.553-67.655 15.063" />
        <path d="M167.486 898.67c8.68-20.425 34.466-33.7 55.145-26.552-21.7 2.808-39.316 11.233-55.145 26.551m-.256 9.957c15.83-15.063 50.806-20.169 61.528-4.34-21.7-6.893-40.593-3.83-61.527 4.34" />
      </g>
      <g fill="#2b1100">
        <path d="M71.493 903.265c-15.318-19.148-46.72-28.339-67.655-15.063 24.509-3.83 46.72 2.553 67.655 15.063" />
        <path d="M72.514 898.67c-8.68-20.425-34.466-33.7-55.145-26.552 21.7 2.808 39.316 11.233 55.145 26.551m.256 9.957c-15.83-15.063-50.806-20.169-61.528-4.34 21.7-6.893 40.593-3.83 61.527 4.34" />
      </g>
      <path

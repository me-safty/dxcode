...
export default function GitActionsControl({
  ...
  const handleGitActionsOpenChange = (open: boolean) => {
    if (open) {
  ...
  const renderControl = () => {
    ...
    if (inMenu) {
      return (
        <MenuSub onOpenChange={handleGitActionsOpenChange}>
          <MenuSubTrigger disabled={isGitActionRunning}>
            <SourceControlIcon />
            Git
          </MenuSubTrigger>
          <MenuSubPopup className="min-w-44">{gitActionMenuContent}</MenuSubPopup>
        </MenuSub>
      );
    }
    ...
    return (
      <Group aria-label="Git actions" className="shrink-0">
        ...
        <Menu onOpenChange={handleGitActionsOpenChange}>
          <MenuTrigger

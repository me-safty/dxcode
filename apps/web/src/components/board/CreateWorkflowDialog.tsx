...
type WizardStep = "name" | "choose" | "agent";
...
export function CreateWorkflowDialog({
  ...
  // Apply a create result: navigate on success, surface message/lint on failure.
          ...
          <ul className="space-y-1">
            {sources.map((src, srcIndex) => (
              ...
              >
                ...
                <MetaRow label="enabled">{String(src.enabled)}</MetaRow>

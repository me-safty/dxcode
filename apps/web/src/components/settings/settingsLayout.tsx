...
export function SettingsPageContainer({
  ...
  return (
    <div className="scrollbar-gutter-both min-h-0 flex-1 overflow-y-auto overscroll-y-contain p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom,0px))] sm:p-8 sm:pb-[calc(2rem+env(safe-area-inset-bottom,0px))]">
      <div
        className={cn(

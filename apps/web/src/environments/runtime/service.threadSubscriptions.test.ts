...
vi.mock("@t3tools/client-runtime", async (importOriginal) => {
  ...
  const stubWsClient: WsRpcClient = {
    ...
    workflow: {
      ...
      getBoardDigest: vi.fn(),
      getBoardMetrics: vi.fn(),
      dryRunBoard: vi.fn(),
      listNeedsAttentionTickets: vi.fn(),
      listWorkSourceConnections: vi.fn(),
      createWorkSourceConnection: vi.fn(),
      deleteWorkSourceConnection: vi.fn(),
      listOutboundConnections: vi.fn(),
      createOutboundConnection: vi.fn(),
      deleteOutboundConnection: vi.fn(),
      importBoard: vi.fn(),
      proposeBoardImprovement: vi.fn(),
      listBoardProposals: vi.fn(),
      getBoardProposal: vi.fn(),
      resolveBoardProposal: vi.fn(),
      revertBoardProposal: vi.fn(),
    },
    server: {
      getConfig: vi.fn(),

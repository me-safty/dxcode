...
vi.mock("@t3tools/client-runtime", async (importOriginal) => {
  ...
  const stubWsClient: WsRpcClient = {
    ...
    git: {
      ...
      getPullRequestFileDiff: vi.fn(),
      getPullRequestReviewComments: vi.fn(),
      getPullRequestIssueComments: vi.fn(),
      getPullRequestBody: vi.fn(),
      postPullRequestReviewComment: vi.fn(),
      postPullRequestIssueComment: vi.fn(),
      getPullRequestViewedFiles: vi.fn(),
      setPullRequestFileViewed: vi.fn(),

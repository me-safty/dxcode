...
import type { EnvironmentId, ExecutionEnvironmentDescriptor } from "@workbench/contracts";
...
const SERVER_ENVIRONMENT_DESCRIPTOR_PATH = "/.well-known/workbench/environment";

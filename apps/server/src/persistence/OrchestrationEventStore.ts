...
export const make = Effect.gen(function* () {
  ...
  const append: OrchestrationEventStore["Service"]["append"] = (event) =>
    appendEventRow({
  ...
  const readFromSequence: OrchestrationEventStore["Service"]["readFromSequence"] = (
    sequenceExclusive,
...
export const layer = Layer.effect(OrchestrationEventStore, make);

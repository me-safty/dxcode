...
import Migration0033 from "./Migrations/033_ThreadColdArchive.ts";
import Migration0034 from "./Migrations/034_DeletedThreadCleanupQueue.ts";
...
export const migrationEntries = [
  ...
  [33, "ThreadColdArchive", Migration0033],

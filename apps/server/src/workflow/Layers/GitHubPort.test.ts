...
const ghError = (detail: string): GitHubCliError =>
  new GitHubCliError({ operation: "execute", detail });

const unimplemented = (name: string) => () =>
  Effect.fail(new GitHubCliError({ operation: "execute", detail: `unexpected ${name}` }));
...
interface GhStubs {
  ...
  readonly getDefaultBranch?: GitHubCliShape["getDefaultBranch"];
  readonly listOpenPullRequests?: GitHubCliShape["listOpenPullRequests"];
  readonly createPullRequest?: GitHubCliShape["createPullRequest"];
  readonly mergePullRequest?: GitHubCliShape["mergePullRequest"];
  readonly getPullRequestDetail?: GitHubCliShape["getPullRequestDetail"];
  readonly listPullRequestChecks?: GitHubCliShape["listPullRequestChecks"];
  readonly listPullRequestReviews?: GitHubCliShape["listPullRequestReviews"];
  readonly listPullRequestReviewComments?: GitHubCliShape["listPullRequestReviewComments"];
  readonly getRepositoryCloneUrls?: GitHubCliShape["getRepositoryCloneUrls"];
}

...
const RPC_REQUIRED_SCOPE = new Map<string, AuthEnvironmentScope>([
  ...
  [WS_METHODS.wslListDistributions, AuthOrchestrationReadScope],
  [WS_METHODS.wslBrowse, AuthOrchestrationReadScope],
  [WS_METHODS.wslResolvePath, AuthOrchestrationReadScope],

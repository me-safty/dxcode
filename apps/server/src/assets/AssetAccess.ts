...
const ANDROID_PROJECT_FAVICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" data-fallback="project-favicon-android"><path stroke="#3ddc84" stroke-width="6" stroke-linecap="round" fill="none" d="M50 30L42 14M78 30L86 14"/><path fill="#3ddc84" d="M26 64A38 38 0 0 1 102 64L102 80Q102 86 96 86L32 86Q26 86 26 80Z"/><circle cx="50" cy="52" r="5.5" fill="#fff"/><circle cx="78" cy="52" r="5.5" fill="#fff"/></svg>`;

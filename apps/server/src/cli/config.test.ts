    ...
    Effect.gen(function* () {
      ...
      const fd = yield* openBootstrapFd(
        makeDesktopBootstrap({
          ...
          workspaceFolders: [
            {
              key: "vscode-remote:dev-container+app:/workspaces/app",
              name: "app",
              cwd: "/workspaces/app",
              uriScheme: "vscode-remote",
              uriAuthority: "dev-container+app",
            },
          ],
          activeWorkspaceFolderKey: "vscode-remote:dev-container+app:/workspaces/app",
        }),
      );
      ...
      expect(resolved).toEqual({
        ...
        activeBootstrapWorkspaceFolderKey: "vscode-remote:dev-container+app:/workspaces/app",
        hostMcpServers: [],
        logWebSocketEvents: false,
        tailscaleServeEnabled: false,
        tailscaleServePort: 443,

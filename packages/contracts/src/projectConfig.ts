...
export const ProjectThreadConfig = Schema.Struct({
  newThreadEnvMode: Schema.optional(ThreadEnvMode),
});
export type ProjectThreadConfig = typeof ProjectThreadConfig.Type;

export const ProjectConfig = Schema.Struct({
  $schema: Schema.optional(Schema.String),
  browser: Schema.optional(ProjectBrowserConfig),
  thread: Schema.optional(ProjectThreadConfig),

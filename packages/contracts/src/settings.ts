...
export const DEFAULT_SIDEBAR_SHOW_SUBAGENT_THREADS = false;
...
export const ClientSettingsSchema = Schema.Struct({
  ...
  sidebarShowSubagentThreads: Schema.Boolean.pipe(
    Schema.withDecodingDefault(Effect.succeed(DEFAULT_SIDEBAR_SHOW_SUBAGENT_THREADS)),
  ),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  sidebarShowSubagentThreads: Schema.optionalKey(Schema.Boolean),

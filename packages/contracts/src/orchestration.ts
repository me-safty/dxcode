...
export const ThreadTitleSummaryState = Schema.Literals(["missing", "generated", "manual"]);
export type ThreadTitleSummaryState = typeof ThreadTitleSummaryState.Type;

export const OrchestrationThread = Schema.Struct({
  id: ThreadId,
  projectId: ProjectId,
  title: TrimmedNonEmptyString,
  titleSummaryState: ThreadTitleSummaryState.pipe(
    Schema.withDecodingDefault(() => "missing" as const satisfies ThreadTitleSummaryState),
  ),
...
const ThreadMetaUpdateCommand = Schema.Struct({
  ...
  threadId: ThreadId,
  title: Schema.optional(TrimmedNonEmptyString),
  titleSummaryState: Schema.optional(ThreadTitleSummaryState),
